...
public class CameraFollow : MonoBehaviour 
{
	...
	//controls
	public string cameraHorizontal = "CameraHorizontal";
	public string cameraVertical = "CameraVertical";
	...
	void SmoothFollow()
	{
		...
		else
		{
			...
			float axis = Input.GetAxis (cameraHorizontal) * inputRotationSpeed * Time.deltaTime;
